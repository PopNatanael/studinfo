...
use Frontend\User\Factory\YearControllerFactory;
...
use Frontend\User\Factory\AddGradeDelegator;
    ...
    public function getDependencies(): array
    {
        return [
            'factories'  => [
                ...
                AddGradeForm::class => ElementFactory::class,
